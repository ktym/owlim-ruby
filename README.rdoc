...
This is a Semantic Web program which provides a frontend library and
...
Result will be printed in the tabular text format by default.
...
Use :format => "xml" option to retrieve the results in the SPARQL Query
